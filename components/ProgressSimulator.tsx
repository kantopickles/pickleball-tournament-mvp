              ...
              <article className="panel simulator-event-card" key={event.id}>
                ...
                <div className="simulator-event-content">
                  <div className="simulator-event-fields">
                    ...
                    <label className="field">参加単価（1{unitLabels[event.unit]}あたり）<input className="input" min="0" max="99999" type="number" value={event.entryFee} onChange={(changeEvent) => updateEvent(event.id, "entryFee", clampNumber(Number(changeEvent.target.value), 0, 99999))} /><span className="simulator-input-unit">円</span></label>
                    {event.format === "league" && <>
